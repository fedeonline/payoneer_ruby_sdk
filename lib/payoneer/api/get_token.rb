module Payoneer
  module Api
    ...
    module GetToken
      ...
      def self.to_api_params(payee_id: nil, approved: true, payout_methods: nil, redirect_url: nil, redirect_time: nil, registration_mode: nil)
        {
          p4: payee_id,
          p9: approved,
          p10: true
        }.tap do |params|
          params[:p12] = registration_mode unless registration_mode.nil?
